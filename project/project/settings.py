...
TINYMCE_DEFAULT_CONFIG = {
    ...
    'selector': 'textarea',
    'theme': 'silver',
    'plugins': 'print preview paste importcss searchreplace autolink autosave save directionality code visualblocks visualchars fullscreen  link template codesample table charmap hr pagebreak nonbreaking anchor toc insertdatetime advlist lists wordcount  noneditable help charmap quickbars emoticons',
    ...
    'toolbar2': 'charmap emoticons | fullscreen  preview save print | template link anchor codesample | ltr rtl',
